    ...
    <>
      ...
      <motion.aside
        className={`
          ...
          border-r border-border bg-surface px-1
      ...
      >
        ...
        <div className="flex items-center h-11 shrink-0">
          ...
          <button
            className={`flex items-center justify-center w-9 h-9 outline-none cursor-pointer shrink-0 rounded-lg ml-auto text-text-secondary transition-colors hover:bg-interactive-hover ${
          ...
          <div className="flex flex-col gap-0.5 px-1 pt-1">
            ...
            {NAV_ITEMS.map((item) => (
              <Link
                ...
                className={`flex items-center justify-center w-9 h-9 mx-auto rounded-lg transition-colors duration-100 ${isNavActive(item.href, pathname) ? "bg-interactive-hover text-text-primary" : "text-text-secondary"}`}
              >
                ...
                {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      className={`flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-colors duration-100 ${active ? "bg-interactive-hover text-text-primary font-medium" : "text-text-secondary font-normal"}`}
                      onMouseEnter={(e) => {
                        if (!active) {
                          e.currentTarget.style.background =
                            "var(--interactive-hover)";
