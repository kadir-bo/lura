...
export default function PublicHeader() {
  return (
    <header
      className="fixed top-0 left-0 w-full flex flex-col z-999 border-b border-border bg-background"
    >
      <nav className="flex items-center justify-between max-w-500 w-full mx-auto px-4 lg:px-12 h-14">
        ...
        <div className="w-max flex items-center justify-end gap-2">
          <PrimaryButton
            className="justify-center w-max hidden md:flex border-border hover:border-border-med"
            href="/sign-up"
          >
            Sign up
          </PrimaryButton>
