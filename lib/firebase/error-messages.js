...
export const authErrorMessages = {
  ...
  "auth/operation-not-allowed":
    "This sign-in method is disabled. Enable Anonymous sign-in in Firebase Authentication for demo access.",
  "auth/admin-restricted-operation":
    "Demo sign-up is blocked by this Firebase project. Configure a server-side demo account instead.",
  "auth/demo-auth-not-configured":
    "Demo access is not configured. Enable Anonymous sign-in in Firebase Authentication.",
  "auth/app-not-authorized":
    "This domain is not authorized for Firebase Authentication.",
  "auth/operation-not-supported-in-this-environment":
    "Demo access requires a secure browser context with local storage enabled.",
